    ...
    <div className="absolute top-[1em] z-[1000] w-full left-0 flex justify-center">
      ...
      >
        <a
          ...
          onClick={(e) => {
            e.preventDefault();
            handleLinkClick(items?.[0]?.href || '#home');
          }}
          ref={el => {
            logoRef.current = el;
          }}
            className="rounded-full p-2 inline-flex items-center justify-center overflow-hidden hover:bg-black/10 transition-colors duration-200"
            style={{
              width: 'var(--nav-h)',
              height: 'var(--nav-h)',
        ...
        <div
          ref={navItemsRef}
          className="relative items-center rounded-full hidden md:flex ml-2 hover:bg-black/10 transition-colors duration-200"
          style={{
            height: 'var(--nav-h)',
            background: 'var(--base, transparent)'
          }}
        ...
        <button
          ...
          className="md:hidden rounded-full border-0 flex flex-col items-center justify-center gap-1 cursor-pointer p-0 relative hover:bg-black/10 transition-colors duration-200"
          style={{
            width: 'var(--nav-h)',
            height: 'var(--nav-h)',
            background: 'var(--base, transparent)'
        ...
        >
          <span
            className="hamburger-line w-4 h-0.5 rounded origin-center hamburger-transition"
      ...
      >
        <ul className="list-none m-0 p-[3px] flex flex-col gap-[3px]">
          {items.map(item => {
            ...
            const linkClasses =
              'block py-3 px-4 text-[16px] font-medium rounded-[50px] pill-link-transition';
